<template>
	<div v-if="props.chatStatus" class="wrapper chat__filled-wrapper" :class="{ 'chat__filled-wrapper_small': !props.chatStatus }">
		<!-- Chat Header -->
		<div class="chat__header">
			<button @click="closeChat" class="button back-btn_small">
	...
	<div v-else class="wrapper chat__empty-wrapper" :class="{ 'chat__filled-wrapper_small': !props.chatStatus }">
		<svg class="chat__icon" xmlns="http://www.w3.org/2000/svg" width="120" height="91" viewBox="0 0 120 91" fill="none">
			<g clip-path="url(#clip0_3_52422)">
				...
				<path
					...
					fill="#FFD8A7" />
				<path d="M15.1351 84.2671C15.1351 84.2671 31.3513 61.2456 41.7297 50.8208C41.7297 51.038 21.1892 64.2862 15.1351 84.2671Z" fill="#FFD8A7" />
				<path
					opacity="0.4"
				...
				<path
					...
					fill="#C60055" />
				<path d="M53.6216 54.2959C51.027 53.8615 85.8378 33.8806 85.8378 33.8806C85.8378 33.8806 65.7297 52.1241 53.6216 54.2959Z" fill="#FFC59F" />
				<path
					opacity="0.4"
				...
				<path
					...
					fill="#FFB64A" />
				<path d="M54.4865 29.1025C51.8919 29.7541 57.0811 33.4462 61.1892 33.0118C65.2973 32.3603 60.3243 27.7994 54.4865 29.1025Z" fill="white" />
				<path d="M56.8649 64.2863C55.5676 64.0691 59.4595 60.5941 60.5406 61.0285C61.8378 61.4629 59.8919 64.9378 56.8649 64.2863Z" fill="white" />
				<path
					opacity="0.2"
			...
			<defs>
				<linearGradient id="paint0_linear_3_52422" x1="60.0473" y1="91.0818" x2="60.0473" y2="-9.92511e-05" gradientUnits="userSpaceOnUse">
					<stop stop-color="#FFA274" />
					<stop offset="1" stop-color="#FFC488" />
				</linearGradient>
				<linearGradient id="paint1_linear_3_52422" x1="52.0463" y1="67.1278" x2="52.0463" y2="28.3031" gradientUnits="userSpaceOnUse">
